...
export const addCollaborator = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!hasPermission) {
      throw new Error(
        "You do not have permission to add collaborators to this feed",
      );
    }
    ...
    const existingCollaborator = await ctx.db
      .query("feedCollaborators")
      .withIndex("feedId_userId", (q: any) =>
        q.eq("feedId", args.feedId).eq("userId", args.userId),
      )
      .unique();
...
export const removeCollaborator = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!hasPermission) {
      throw new Error(
        "You do not have permission to remove collaborators from this feed",
      );
    }
...
export const updateCollaboratorRole = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!hasPermission) {
      throw new Error(
        "You do not have permission to update collaborator roles for this feed",
      );
    }
...
export const getFeedCollaborators = query({
  ...
  handler: async (ctx, args) => {
    ...
    if (feed.createdBy === user._id) {
      ...
      if (!collaborator) {
        throw new Error(
          "You do not have permission to view collaborators for this feed",
        );
      }
    }
